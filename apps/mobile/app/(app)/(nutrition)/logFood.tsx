...
export default function LogFood() {
  ...
  const servingSizeMultiplier =
    servingSize && !userId ? Number(servingSize) : 1;
  ...
  const nutritionFactsCarbohydrates =
    Number(carbohydrates) * servingSizeMultiplier;
  ...
  const nutritionFactsSaturatedFat =
    Number(saturatedFat) * servingSizeMultiplier;
  const nutritionFactsPolyunsaturatedFat =
    Number(polyunsaturatedFat) * servingSizeMultiplier;
  const nutritionFactsMonounsaturatedFat =
    Number(monounsaturatedFat) * servingSizeMultiplier;
  ...
  const handleServingSizeChange = (value: string) => {
    ...
    setCarbsLabel(
      toSignificantFigures(Number(carbohydrates) * newTotalMultiplier)
    );
  ...
  const handleNumberOfServingsChange = (value: string) => {
    ...
    if (userId && selectedServingSize === "1g") {
      ...
      servingSize &&
      selectedServingSize === `${servingSize} ${servingSizeUnit}`
    ) {
      currentServingSizeMultiplier = Number(servingSize);
    }

    const newTotalMultiplier =
      currentServingSizeMultiplier * newNumberOfServings;
      ...
      <ScrollView className="px-4">
        ...
        <View className="flex-col mt-10">
          <View className="flex-col">
            ...
            <View
              className="border-gray2 border rounded-2xl overflow-hidden h-14 w-48 justify-center mt-4"
            ...
            >
              ...
              >
                {servingSize && (
                  <Picker.Item
                    label={`${servingSize} ${servingSizeUnit}`}
                    value={`${servingSize} ${servingSizeUnit}`}
                    style={{ backgroundColor: "black", color: "white" }}
                  />
                )}
                <Picker.Item
                  label={addType === "logRecipe" ? "1 Serving" : "1g"}
                  value="1g"
                  style={{ backgroundColor: "black", color: "white" }}
                />
              </Picker>
        ...
        <View className="flex-col gap-10 w-full">
          <View className="flex-row justify-between gap-2 w-full">
            ...
            <Text className="text-white text-lg font-[HelveticaNeue] font-medium">
              {nutritionFactsCalories.toFixed(0)}
            </Text>
          </View>
          <View className="flex-col gap-2 w-full">
            <View className="flex-row justify-between gap-2 w-full">
              ...
              <Text className="text-white text-lg font-[HelveticaNeue] font-medium">
                {toSignificantFigures(nutritionFactsFat)}g
              </Text>
            </View>
            ...
            <View className="gap-4">
              <View className="flex-row justify-between gap-2 w-full">
                ...
                <Text className="text-gray3 text-lg font-[HelveticaNeue] font-medium">
                  {nutritionFactsSaturatedFat
                    ? `${toSignificantFigures(nutritionFactsSaturatedFat)}g`
                    : "-"}
                </Text>
              </View>
              <View className="flex-row justify-between gap-2 w-full">
                ...
                <Text className="text-gray3 text-lg font-[HelveticaNeue] font-medium">
                  {nutritionFactsTransFat
                    ? `${toSignificantFigures(nutritionFactsTransFat)}g`
                    : "-"}
                </Text>
              </View>
              <View className="flex-row justify-between gap-2 w-full">
          ...
          <View className="flex-row justify-between gap-2 w-full">
            ...
            <Text className="text-white text-lg font-[HelveticaNeue] font-medium">
              {nutritionFactsCholesterol
                ? `${nutritionFactsCholesterol.toFixed(0)}mg`
                : "0mg"}
            </Text>
          </View>
          <View className="flex-row justify-between gap-2 w-full">
            ...
            <Text className="text-white text-lg font-[HelveticaNeue] font-medium">
              {nutritionFactsSodium
                ? `${nutritionFactsSodium.toFixed(0)}mg`
                : "0mg"}
            </Text>
          </View>
          <View className="flex-col gap-2 w-full">
            <View className="flex-row justify-between gap-2 w-full">
              ...
              <Text className="text-white text-lg font-[HelveticaNeue] font-medium">
                {toSignificantFigures(nutritionFactsCarbohydrates)}g
              </Text>
            </View>
            ...
            <View className="gap-4">
              <View className="flex-row justify-between gap-2 w-full">
                ...
                <Text className="text-gray3 text-lg font-[HelveticaNeue] font-medium">
                  {nutritionFactsFiber
                    ? `${toSignificantFigures(nutritionFactsFiber)}g`
                    : "-"}
                </Text>
              </View>
              <View className="flex-row justify-between gap-2 w-full">
                ...
                <Text className="text-gray3 text-lg font-[HelveticaNeue] font-medium">
                  {nutritionFactsSugar
                    ? `${toSignificantFigures(nutritionFactsSugar)}g`
                    : "-"}
                </Text>
              </View>
              <View className="flex-row justify-between gap-2 w-full">
          ...
          <View className="flex-row justify-between gap-2 w-full mb-32">
            ...
            <Text className="text-white text-lg font-[HelveticaNeue] font-medium">
              {toSignificantFigures(nutritionFactsProtein)}g
            </Text>
          </View>
        </View>
      </ScrollView>
